...
class UpdateUsersRoleRepositoryTest {
  ...
  public void update() throws DuplicatedKeyException {
    ...
    // update 1 of the roles in the user 1
    Role updatedRole1 = new Role("2", "name", "", "", new ArrayList<>());
    ...
    // check if only the role in the user 1 has been updated
    assertEquals("", responseUser1.getRoleById("1").getName());
