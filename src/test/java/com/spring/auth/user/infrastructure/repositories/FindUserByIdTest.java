...
public class FindUserByIdTest {
  ...
  @Test
  public void init() {
    assertNotNull(findUserByIdRepository);
  ...
  public void find() {
    ...
    when(userRepositoryJpa.findById(Mockito.any())).thenReturn(Optional.of(userJpa));

    User expectedResponse = UserMapper.parse(userJpa);
    User response = findUserByIdRepository.find("id");
  ...
  public void findNotFoundException() {
    ...
    assertThrows(NotFoundException.class, () -> findUserByIdRepository.find("id"));
  }
}
